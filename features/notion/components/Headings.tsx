...
export function Heading_1({ block }: NotionComponentProps<'heading_1'>) {
  ...
  return (
    <h2 id={cleanUrl(block.heading_1.rich_text[0].plain_text)} className={h1}>
      {TITLE}
    </h2>
  )
}
...
export function Heading_2({ block }: NotionComponentProps<'heading_2'>) {
  ...
  return (
    <h3 id={cleanUrl(block.heading_2.rich_text[0].plain_text)} className={h2}>
      {TITLE}
    </h3>
  )
}
...
export function Heading_3({ block }: NotionComponentProps<'heading_3'>) {
  ...
  return (
    <h4 id={cleanUrl(block.heading_3.rich_text[0].plain_text)} className={h3}>
      {TITLE}
    </h4>
  )
}
