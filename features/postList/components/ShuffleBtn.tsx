...
import { type AnimationEventHandler, type MouseEventHandler, useState } from 'react'
...
export function ShuffleBtn() {
  ...
  return (
    <button type="button" onClick={handleClick} onAnimationEnd={handleAnimationEnd} className={clsx(css.shuffleBtn, rotating && css.rotate)}>
